...
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandSeparator } from "@/src/common/components/shadcn/command";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "@/src/common/components/shadcn/dropdown-menu";
import { HoverCard, HoverCardContent, HoverCardTrigger } from "@/src/common/components/shadcn/hover-card";
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupTextarea } from "@/src/common/components/shadcn/input-group";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/src/common/components/shadcn/select";
import { Spinner } from "@/src/common/components/shadcn/spinner";
import { Tooltip, TooltipContent, TooltipTrigger } from "@/src/common/components/shadcn/tooltip";
...
export const PromptInputActionAddAttachments = ({ label = "Add photos or files", onClick, ...props }: PromptInputActionAddAttachmentsProps) => {
	const attachments = usePromptInputAttachments();

	const handleClick: ComponentProps<typeof DropdownMenuItem>["onClick"] = useCallback(
		(e) => {
			onClick?.(e);
...
export const PromptInputActionAddScreenshot = ({ label = "Take screenshot", onClick, ...props }: PromptInputActionAddScreenshotProps) => {
	const attachments = usePromptInputAttachments();
...
export const PromptInputSubmit = ({
	...
	const handleClick: ComponentProps<typeof InputGroupButton>["onClick"] = useCallback(
		(e) => {
